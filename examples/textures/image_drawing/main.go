...
func main() {
	...
	rl.ImageCrop(&cat, rl.MakeRectangle(100, 10, 280, 380)) // Crop an image piece
	...
	rl.ImageDraw(&parrots, cat, rl.MakeRectangle(0, 0, float32(cat.Width), float32(cat.Height)), rl.MakeRectangle(30, 40, float32(cat.Width)*1.5, float32(cat.Height)*1.5), rl.White)
	rl.ImageCrop(&parrots, rl.MakeRectangle(0, 50, float32(parrots.Width), float32(parrots.Height-100))) // Crop resulting image
